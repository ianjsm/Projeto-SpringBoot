...
import com.projetos.projeto.entities.Payment;
import com.projetos.projeto.entities.Product;
import com.projetos.projeto.entities.User;
import com.projetos.projeto.entities.enums.OrderStatus;
import com.projetos.projeto.repositories.CategoryRepository;
import com.projetos.projeto.repositories.OrderItemRepository;
import com.projetos.projeto.repositories.OrderRepository;
import com.projetos.projeto.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o1 = new Order(null, Instant.parse("2024-02-20T19:53:07Z"), OrderStatus.SHIPPED, u1);
		Order o2 = new Order(null, Instant.parse("2024-02-21T03:42:10Z"), OrderStatus.PAID, u2);
		Order o3 = new Order(null, Instant.parse("2024-01-22T15:21:22Z"), OrderStatus.DELIVERED, u1);
		...
		Payment pay1 = new Payment(null, Instant.parse("2024-02-20T23:53:07Z"), o1);
		o1.setPayment(pay1);
